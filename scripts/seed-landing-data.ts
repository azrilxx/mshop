...
const fallbackCategories: LandingCategory[] = [
  { id: 'cra', name: 'Corrosion-Resistant Alloys (CRA)', imageUrl: await imageLibrary.getImageByTag('cra', 'category') },
  { id: 'vessels', name: 'Pressure Vessels & Flanges', imageUrl: await imageLibrary.getImageByTag('pressure', 'category') },
  { id: 'rope', name: 'Rope Access Equipment', imageUrl: await imageLibrary.getImageByTag('rope', 'product') },
  { id: 'pipe', name: 'Pipe Cleaning Tools', imageUrl: await imageLibrary.getImageByTag('pipe', 'product') },
  { id: 'measure', name: 'Measurement & Instrumentation', imageUrl: await imageLibrary.getImageByTag('measurement', 'product') },
  { id: 'tanks', name: 'Rental Tanks & Storage', imageUrl: await imageLibrary.getImageByTag('storage', 'category') },
  { id: 'valves', name: 'Valves & Actuators', imageUrl: await imageLibrary.getImageByTag('valve', 'product') },
  { id: 'offshore', name: 'Offshore & Marine Equipment', imageUrl: await imageLibrary.getImageByTag('offshore', 'product') }
]
  ...
  const scrapedProducts: LandingProduct[] = [
    {
      ...
      price: 145,
      imageUrl: await imageLibrary.getImageByTag('pipe', 'product'),
      region: 'Norway',
    ...
    },
    {
      ...
      price: 285,
      imageUrl: await imageLibrary.getImageByTag('fitting', 'product'),
      region: 'Germany',
    ...
    },
    {
      ...
      price: 3200,
      imageUrl: await imageLibrary.getImageByTag('valve', 'product'),
      region: 'USA',
    ...
    },
    {
      ...
      price: 450000,
      imageUrl: await imageLibrary.getImageByTag('offshore', 'product'),
      region: 'Aberdeen, UK',
...
export async function seedLandingData() {
  try {
    ...
    await db.set('section:hero', {
      ...
      backgroundImage: await imageLibrary.getImageByTag('industrial', 'banner')
    })
